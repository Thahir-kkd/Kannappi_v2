...
if (Config.WORKTYPE == 'private') {
    ...
    Asena.addCommand({pattern: 'owner', fromMe: true, desc: 'shows the detail of bot owner'}, (async (message, match) => {
        ...
        if (Config.PLK == 'default') {
            await message.client.sendMessage(message.jid,'kannappi Bot created by *Thahir*' , MessageType.text);
        }
        else {
    ...
    Asena.addCommand({pattern: 'owner', fromMe: false, desc: 'shows the detail of bot owner'}, (async (message, match) => {
        ...
        if (Config.PLK == 'default') {
            await message.client.sendMessage(message.jid,'_*kannappi Bot created by Thahir*_                                                                                    *git link https://github.com/thahir-msd*' , MessageType.text);
        }
        else {
            await message.client.sendMessage(message.jid,Config.PLK + '\n\n--------------------', MessageType.text);
        }

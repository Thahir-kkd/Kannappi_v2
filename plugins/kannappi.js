...
Asena.addCommand({pattern: 'thahir', fromMe: false,dontAddCommandList: true}, (async (message, match) => {

    var r_text = new Array ();    
r_text[0] = "\nEda eda, mandankonappi.. Nee enne kooduthal mandan aakkatheda\n";
r_text[1] = "Thahirne tholpikkaan ningalkavilla. Jeevitathil pinkiye tholpichittundu… palarum… palavattom…😥😥 aarellum aaa sed bgm onn iduo...";
r_text[2] = "Thahir says i love you 😘";
r_text[3] = "Pikchude yudhangal Company Kanan Povunnatheyuloo";
r_text[4] = "hi, how are you";
r_text[5] = "ennikk korch rest theroo...🥵🥵";
r_text[6] = "Thahir - eva - simsim \ningane ethra ethra paerugal aan alle enikk..😂🤣";
...
r_text[8] = "\n enne vilicho...?🧐 \n";
r_text[9] = "ente per Thahir,ninte per donkey, backi ellarum monkey😼😼";
...
r_text[22] = "Kaanaan oru look illanney ullu… bhayankara budhiya\n\n ninnak allatto enik Thahir";
r_text[23] = "Ithalla ithinapparam chaadi kadannavananee K.K. Thahir";
